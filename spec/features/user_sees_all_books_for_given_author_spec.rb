  ...
  describe "When I visit author show page" do
    ...
    it 'should show the top review for each book' do
      ...
      within("main") do
        ...
        expect(page).to have_content("#{@review_4.rating} stars")
        expect(page).to_not have_content("#{@review_1.rating} stars")
        expect(page).to_not have_content("#{@review_3.rating} stars")
