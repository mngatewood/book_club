...
describe "As a vistitor" do
  ...
  describe "when I click sort by Highest to Lowest Rating" do
    ...
    it 'should show all books sorted by rating in descending order' do

      visit '/books?sort=rating-desc'
  ...
  describe "when I click sort by Lowest to Highest Rating" do

    it 'should show all books sorted by rating in ascending order' do

      visit '/books?sort=rating-asc'
