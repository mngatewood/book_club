...
describe "As a vistitor" do
  ...
  describe "when I click sort by Most to Least Reviews" do

    it 'should show all books sorted by reviews in descending order' do

      visit '/books?sort=reviews-desc'
  ...
  describe "when I click sort by Lowest to Most Reviews" do

    it 'should show all books sorted by reviews in ascending order' do

      visit '/books?sort=reviews-asc'
